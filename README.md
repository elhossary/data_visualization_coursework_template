...
- *Report*
  ...
  - Should include
    ...
    - References
 ### MCQ
 - Generate Multiple choice questions on each lecture you attend with their answers (in your fork) as in the examples file in the MCQ directory then make a pull request to this repo.
